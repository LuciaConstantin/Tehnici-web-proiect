...
CREATE USER lucia WITH ENCRYPTED PASSWORD 'lucia';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO lucia ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO lucia;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO lucia;