...
class AccesBD{
    static #instanta=null; // # este private
    static #initializat=false;
    //clasa este singleton, exista o singura conexiune la baza de date
    //nu exista constructor privat in js, se vrea apelarea constructorului o singura data
    constructor() {
        if(AccesBD.#instanta){
    ...
    initLocal(){
        ///this propritetate a obiectului
    ...
    ///daca nu exista instanta se creeaza daca exista se returneaza
    static getInstanta({init="local"}={}){ 
        console.log(this);//this-ul e clasa nu instanta pt ca metoda statica
        if(!this.#instanta){ //daca nu exista instanta se creeaza 
            ...
            try{
                switch(init){ ///daca este valoarea default
